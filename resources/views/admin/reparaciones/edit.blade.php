        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{route('reparaciones.update', $reparaciones -> id)}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="id_user" class="form-control" value="{{ $reparaciones -> id_user }}"></input>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="estado" class="form-control" data-toggle="dropdown" aria-expanded="false">
                        <option value="{{ $reparaciones -> estado }}" class="dropdown-item" role="presentation">{{ $reparaciones -> estado }}</option>
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" rows="5" name="descripcion" class="form-control" placeholder="{{ $reparaciones -> descripcion }}"></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="fecha_hora" class="form-control" value="{{ $reparaciones -> fecha_hora }}"></input>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="ubicacion" class="form-control" value="{{ $reparaciones -> ubicacion }}"></input>
                </div>
